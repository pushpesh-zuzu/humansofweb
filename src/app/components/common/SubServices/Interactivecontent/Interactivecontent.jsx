            ...
            <div className="grid gap-5 rounded-[12px] bg-white p-4 md:p-5 lg:grid-cols-[minmax(280px,0.38fr)_minmax(0,0.62fr)]">
                ...
                {items.map((item, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex min-h-[76px] w-full cursor-pointer items-center gap-4 rounded-[14px] px-4 text-left transition ${
                        isActive
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1 text-h6 font-bold">
                        {item.title}
                      </span>
              ...
              <div className="rounded-[14px] border border-primary/25 bg-[#f4fbff] p-6 md:p-8 lg:p-10">
                <div className="flex min-h-[360px] flex-col justify-center">
                  {isJSXIcon ? (
                    <div className="h-[110px] w-[110px] md:h-[132px] md:w-[132px]">
                      {activeItem.icon}
                    </div>
                  ) : (
                    <Image
                  ...
                  <h3 className="mt-6 text-h4 font-bold text-primary">
                    {activeItem.title}
                  </h3>
