...
export const brandTrustParaBoltAI = [
  "Successful AI-powered products require more than fast development. Teams also need scalable architecture, smooth workflows, and systems that support long-term growth.",
...
export const BOLT_AI_TIMELINE = [
  {
    ...
    description:
      "We begin by understanding your product goals, workflows, technical requirements, and scalability expectations before building your Bolt AI solution.",
    iconPath: "audit",
  },
  {
    title: "Workflow Architecture",
    description:
      "Our team designs AI-powered workflows, automation systems, and scalable development architecture tailored to your business operations.",
    iconPath: "research",
  },
  {
    title: "Rapid AI Prototyping",
    description:
      "We use Bolt AI to accelerate product prototyping, interface development, and feature testing so your team can validate ideas faster.",
    iconPath: "keyword",
  },
  {
    title: "Custom Feature Development",
    description:
      "We build custom product features, AI integrations, workflow automations, dashboards, and scalable application functionality.",
    iconPath: "shopping",
  },
  {
    title: "AI Workflow Optimization",
    description:
      "Our developers optimize AI-assisted workflows for better performance, faster execution, and improved development efficiency.",
    iconPath: "creative",
  },
  {
    title: "Testing & Performance Review",
    description:
      "We thoroughly test your Bolt AI application for usability, performance, workflow reliability, and scalability before deployment.",
    iconPath: "bidding",
  },
  {
    title: "Deployment & Scaling",
    description:
      "Once everything is validated, we deploy your application and help scale workflows, infrastructure, and AI-powered systems as your business grows.",
    iconPath: "scale",
  },
];
...
export const BOLT_AI_DEV_SERVICES = [
  {
...
export const BOLT_AI_FAQ_DATA = [
  {
    question: "What is Bolt AI used for?",
    answer:
      "Bolt AI helps businesses accelerate product development, automate workflows, build scalable applications, and improve development efficiency using AI-assisted systems.",
  },
  {
    question: "Can Bolt AI help startups build MVPs faster?",
    answer:
      "Yes. Bolt AI is highly effective for rapid MVP development because it speeds up workflows, reduces repetitive development tasks, and supports faster iteration cycles.",
  },
  {
    question: "Do you provide custom Bolt AI development?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. We provide long-term support, workflow optimization, feature updates, scalability improvements, and technical maintenance after launch.",
  },
];
