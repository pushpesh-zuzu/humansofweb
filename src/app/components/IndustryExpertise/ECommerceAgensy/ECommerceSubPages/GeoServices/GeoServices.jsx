...
import detailedAuditIcon from '@/app/components/common/Icons/IndustryExpertise/detailed-audit.svg'
import competitorAnalysisIcon from '@/app/components/common/Icons/IndustryExpertise/competitor-analysis.svg'
import keywordResearchIcon from '@/app/components/common/Icons/IndustryExpertise/keyword-research.svg'
import organicTrafficIcon from '@/app/components/common/Icons/IndustryExpertise/organic-web-traffic.svg'
...
const GEO_STEPS = [
    {
        step: "01",
        title: "Audit Your Discovery Footprint",
        description: "We assess how your store currently appears in organic, local, and AI-driven search channels to uncover gaps and opportunity areas.",
        // icon: detailedAuditIcon,
    },
    {
        step: "02",
        title: "Optimize Product Search Signals",
        description: "We refine titles, categories, metadata, and schema to improve how products are understood by search engines, making discovery much easier.",
        // icon: keywordResearchIcon,
    },
    {
        step: "03",
    ...
    },
    {
        ...
        description: "From landing page flow to product discovery, we make the path from search to checkout clearer, faster, and more compelling.",
        // icon: competitorAnalysisIcon,
    },
    {
        step: "05",
