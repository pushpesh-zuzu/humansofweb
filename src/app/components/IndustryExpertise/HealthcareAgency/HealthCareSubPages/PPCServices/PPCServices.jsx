...
const STEPS = [
    ...
    {
        step: "02",
        title: "Build Precision Targeting Strategy",
        description:
            "We create targeted campaigns using high-performing keywords, audience signals, and geo-targeting to ensure your ads reach the most relevant patients.",
    },
    {
        step: "03",
        title: "Craft High-Impact Ad Creatives",
        description:
            "We develop compelling ad copy and creatives that highlight your expertise, build trust, and motivate patients to take action.",
    },
    {
        step: "04",
